...
namespace Utp
{
	...
	{
		public event Action<bool> OnSuccessfullySignIn;

		public string JoinCode { get; set; } = "Join code";
		...
		private async void Start()
		{
			...
			OnSuccessfullySignIn?.Invoke(true);
		}
		...
		public void AllocateRelayServer(int maxPlayers, string regionId = null, Action<string> onSuccess = null, Action onFailure = null)
		{
